...
{if $externalLayers}
<div id="externallayers-menu" class="externallayers" style="display:none;">
  <h3><span class="title"><span class="icon"></span>&nbsp;{@view~map.externallayermenu.title@}</span></span></h3>
  <div class="menu-content">
    <div id="externallayers">
        <div id="dialog-external-layers" title="{@view~map.externallayermenu.title@}">
